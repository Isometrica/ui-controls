  ...
  */
  ...
  /*
	...
	*/
	...
	/*
		STANDARD - Show description field when issue number edited
	*/

	$(document).on("change", "#standardIssueNumberInput", function() {
		$("#standardIssueDescriptionInput textarea").val('');
		$("#standardIssueDescriptionInput").collapse("show");
